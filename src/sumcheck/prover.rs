    ...
    F: Field,
{
    ...
    /// Absorb the challenge `challenge`.
    fn absorb(&mut self, challenge: F);
    // Return the total number of rounds in the protocol.
    fn rounds(&self) -> usize;
    /// Current round number.
    fn round(&self) -> usize;
    /// Return the final statement if at the final round,
    /// otherwise return None.
    fn final_statements(&self) -> Option<[F; 2]>;
}
